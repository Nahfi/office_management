...
Add Work Report
@endsection
@section('work_reports_create_active')
active
@endsection
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('employee.workReport.index') }}"> All Report
                                </a>
                            </li>
                    ...
                    <div class="card-body  ">
                        <div class="row mx-auto ">
                            <div class="col-lg-6 col-6  col-sm-6 col-md-6  mx-auto   ">
                                <form  action="{{ route('employee.workReport.store') }}" class="outer-repeater" method="post">
                                  @csrf
