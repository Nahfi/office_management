...
@section('work_reports_active')
mm-active
@endsection
@section('work_reports_index_active')
active
@endsection
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row" id="reportbody">
            @include('employee.pages.includes.workReport')
        </div>
    </div>
</div> <!-- container-fluid -->
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('employee.workReport.store') }}" method="post">
                    @csrf
                    <div class="row">
...
<script>
    $(function () {
        ...
        $(document).on('submit', '#report_form', function (e) {
            ...
            if (report == '') {
                ...
                $.ajax({
                    method: "post",
                    url: '/employee/work-report/store-report-details',
    ...
    $(document).on('click', '#titleedit', function (e) {
        ...
        $.ajax({
            method: 'get',
            url: `/employee/work-report/edit/${edit_id}`,
            dataType: 'json'
        }).done(response => {
    ...
    $(document).on('submit', '#update_title', function (e) {
        ...
        if (title == '') {
            ...
            $.ajax({
                method: "post",
                url: '/employee/work-report/update',
                data: new FormData(this),
                processData: false,
                contentType: false,
                async: false
    ...
    $(document).on('click', '#delete_report', function (e) {
        ...
        $.ajax({
            method: 'get',
            url: `/employee/work-report/destroy/${deleted_id}`
        }).done(response => {
            $('#reportbody').html(response.view)
            Toast.fire({
                icon: 'success',
    ...
    $(document).on('click', '.sweet_delete', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "get",
                    url: '/employee/work-report/parmanent-delete/' + delete_id,
                    data: data,
    ...
    $(document).on('click', '#restore', function (e) {
        ...
        $.ajax({
            method: 'get',
            url: `/employee/work-report/restore/${restore_id}`
        }).done(response => {
            $('#reportbody').html(response.view)
            Toast.fire({
                icon: 'success',
    ...
    $(document).on('click', '#edit_details', function (e) {
        ...
        $.ajax({
            method: 'get',
            url: `/employee/work-report/edit-details/${edit_id}`,
            dataType: 'json'
        }).done(response => {
    ...
    $(document).on('submit', '#update_details', function (e) {
        ...
        if (details == '') {
            ...
            $.ajax({
                method: "post",
                url: '/employee/work-report/update-details',
                data: new FormData(this),
                processData: false,
                contentType: false,
                async: false
    ...
    $(document).on('click', '#delete_details', function (e) {
        ...
        $.ajax({
            method: 'get',
            url: `/employee/work-report/destroy-details/${deleted_id}`
        }).done(response => {
            $('#reportbody').html(response.view)
            Toast.fire({
                icon: 'success',
    ...
    /*  ==============================
        ...
        if(startDate !="" && endDate!=""){
            if(startDate > endDate){
                ...
                $.ajax({
                    method: 'get',
                    url: `/employee/work-report/search-by-date`,
                    data:{
                        'startDate' : startDate,
                        'endDate' : endDate,
                    }
