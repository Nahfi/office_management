                                    ...
                                    <div class="card task-box" id="uptask-2">
                                        <div class="card-body">
                                            ...
                                            <ul class="ps-3 mb-4 text-muted" id="task-desc">
                                                ...
                                                @forelse($pendingReport->MeetingReportDetails as $details)
                                ...
                                <div id="upcoming-task" class="pb-1 task-list">
                                    <div class="card task-box" id="uptask-2">
                                        <div class="card-body">
                                            ...
                                            <ul class="ps-3 mb-4 text-muted" id="task-desc">
                                           @forelse($approvedReport->MeetingReportDetails as $details)
                                ...
                                <div id="upcoming-task" class="pb-1 task-list">
                                    <div class="card task-box" id="uptask-2">
                                        <div class="card-body">
                                            ...
                                            <ul class="ps-3 mb-4 text-muted" id="task-desc">
                                             @forelse($deletedReport->MeetingReportDetails as $details)
                                                   <li class="py-1">{{ $details->report }}</li>
                                           @empty
                                                       <p> no details found </p>
                                           @endforelse
