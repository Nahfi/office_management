    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('employee.testReport.index') }}">All Test Report </a></li>
                            <li class="breadcrumb-item active">Edit Test Report</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-12s">
                <div class="card">
                    <div class="card-body">
                      <form action="{{ route('employee.testReport.update',$testReport->id) }}" method="POST" enctype="multipart/form-data">
                          @csrf
                          <div class="row justify-content-center">
                              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                  <div class="form-group">
                                      <label>Test Report File <span class="text-danger">*</span> </label>
                                      <a class="mt-1 mb-2 btn btn-sm btn-primary" href="{{ route('employee.testReport.show',$testReport->id) }}">Test Report<i  class="ms-1 fas fa-download"></i></a>
