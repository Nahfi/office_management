                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('employee.testReport.show',$report->id) }}">
                                                        ...
                                                        <a href="{{ route('employee.testReport.destroy',$report->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Data will be deleted!!')"> <i class="fas fa-trash-alt"></i> </a>

                                                    <a href="{{ route('employee.testReport.edit',$report->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-user-edit" >
                                                        </i> </a>
