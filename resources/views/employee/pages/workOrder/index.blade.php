                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">All Work Order</li>
                        </ol>
                    </div>
                </div>
            </div>
                                        ...
                                        @foreach($projects as $project)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('employee.workOrder.edit',$project->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-user-edit" ></i></a>
                                                    <a href="{{ route('employee.workOrder.destroy',$project->id) }}" class="btn btn-sm btn-danger" onclick="return confirm('Data will be deleted!!')"> <i class="fas fa-trash-alt"></i> </a>

                                                    <a class="btn btn-sm btn-primary" href="{{ route('employee.workOrder.show',$project->id) }}">Work Order<i  class="ms-1 fas fa-download"></i></a>
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="{{ route('employee.workOrder.showTestReport',$project->id) }}">Test Report <i  class="fas fa-eye"></i></a>
...
@section('employee_js')
       ...
       @if (Session::has('work_order_delete_success'))
        <script>
            Toast.fire({
                icon: 'success',
                title: "{{ Session::get('work_order_delete_success') }}"
            })
        </script>
    @endif
