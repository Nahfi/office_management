                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                        <div id="category_button">
                                            ...
                                            <a href="{{ route('admin.expense.category.trash',) }}"  class="btn btn-sm mb-2 btn-danger">Trush({{ $data['total_deleted_category'] }})</a>
                                    ...
                                    <tbody>
                                        @foreach($data['categories'] as $category)
                                            <tr>
                                                ...
                                                <td>{{ $category->edited_by != '' ? $category->editedBy->name:'N/A' }}</td>
                                                <td>
                                                    @if (Route::currentRouteName() == 'admin.expense.category.index' || Route::currentRouteName() == 'admin.expense.category.active' || Route::currentRouteName() == 'admin.expense.category.deactive' )
                                                        @if (Auth::guard('admin')->User()->can('expense.category.edit'))
