                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('admin.meetingReport.index') }}">All Report</a></li>
                                                    ...
                                                    <div class="card task-box" id="uptask-2">
                                                        <div class="card-body">
                                                            ...
                                                            <ul class="ps-3 mb-4 text-muted" id="task-desc">
                                                                ...
                                                                @forelse($report->meetingReportDetails as $details)
