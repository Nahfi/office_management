                ...
                <div class="email-rightbar mb-3">
                    <div class="card">
                       <div class="btn-toolbar gap-2 p-3" role="toolbar">
                           <div class="btn-group">
                               @if ( app('router')->getRoutes()->match(app('request')->create(url()->previous()))->getName() == 'admin.email.trash')
                               <a   href="{{ route('admin.email.restore', $allEmailInfo['emailInfo'] ->id) }}"   class="btn btn-success waves-light waves-effect"><i
                                class="fas fa-trash-restore"></i></a>
                                @else
                                <a   href="{{ route('admin.email.destroySentEmail', $allEmailInfo['emailInfo'] ->id) }}"   class="btn btn-success waves-light waves-effect"><i
