                        ...
                        <div class="card-body">
                            <form action="{{ route('customer.profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input disabled type="text" class="form-control pe-5 @error('address') is-invalid @enderror"  name="address" placeholder="National Id " value="{{ $customer->total }}">
                                            <label>Total Spend<span class="text-danger">*</span> </label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input disabled type="text" class="form-control pe-5 @error('address') is-invalid @enderror"  name="address" placeholder="National Id " value="{{ $customer->due }}">
                                            <label>Total Due<span class="text-danger">*</span> </label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating mb-3">
                                            <input disabled type="text" class="form-control pe-5 @error('address') is-invalid @enderror"  name="address" placeholder="National Id " value="{{ $customer->paid }}">
